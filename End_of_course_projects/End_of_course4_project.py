...
class WOFplayer(object):
    ...
    def addMoney(self,amt):
        try:
            ...
            print("The thing you entered is not parseable as a number.")
...
class WOFComputerPlayer(WOFplayer):
    ...
    def getPossibleLetters(self,guessed):
        ...
        lst_of_letters=[letter for letter in LETTERS if letter not in guessed]
        if self.prizeMoney>=VOWEL_COST:
            return lst_of_letters
        else:
            return [letter for letter in lst_of_letters if letter not in VOWELS]

    def getMove(self,category,obscuredPhase,guessed):
...
# i haven't wrote the following (unfortunately)
